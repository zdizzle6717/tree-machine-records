...
// Album Releases
{
  ...
  'config': {
    ...
    'validate': {
      'payload': {
        'albumReleaseIds': _joi2.default.array().items(_joi2.default.number().required())
      }
    },
    'cors': {
      'origin': ['*']
  ...
  'config': {
    ...
    'validate': {
      'payload': {
        ...
        'caption': _joi2.default.optional(),
        'catalogueNumber': _joi2.default.optional(),
        'Files': _joi2.default.optional(),
        'iTunesUrl': _joi2.default.optional(),
        'param': _joi2.default.string().required(),
        'releaseDate': _joi2.default.date().required(),
        'spotifyUrl': _joi2.default.optional(),
        'summary': _joi2.default.optional(),
