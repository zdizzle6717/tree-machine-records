...
class DownloadListPage extends React.Component {
    ...
    componentDidMount() {
        document.title = "Tree Machine Records | Digital Downloads By Artist";
					...
					<div className="photo-select">
						{
							this.state.photos.map((photo, i) =>
								<ImageTile key={i} id={1} artistName={photo.artistName} imageUrl={`/images/artists/${photo.artistParam}/photos/${photo.fileName}`} internalLinkUrl={`/artists/${photo.artistParam}/digital-downloads`}/>
							)
						}
					</div>
		        </div>
